...
# -----------------------------------------------------------
# ASSUMING DEFAULT ROLE HERE
# -----------------------------------------------------------
resource "aws_iam_role" "config" {
  name = "config-okulagin"
...
resource "aws_iam_role_policy_attachment" "config" {
  ...
  policy_arn = "arn:aws:iam::aws:policy/service-role/AWSTERRAFORMRole"
}
...
{
  "s3BucketName": "okulagin-veeam0305121401385000000001"
}
EOF
